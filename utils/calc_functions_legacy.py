...
def pre_process_landmark(landmark_list):
    ...
    for index, landmark_point in enumerate(temp_landmark_list):
        ...
        # you're subtracting the the temp landmark coordinates by the landmarmk points coordinates, in this case LANDMARK POINT 0 cordinates
        temp_landmark_list[index][1] = temp_landmark_list[index][1] - base_y
        # you're subtracting the the temp landmark coordinates by the landmarmk points coordinates, in this case LANDMARK POINT 1 cordinates
